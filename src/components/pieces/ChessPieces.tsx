...
/* High-quality Staunton-style SVG chess pieces */
...
const PIECE_COMPONENTS: Record<PieceColor, Record<PieceType, React.FC<PieceProps>>> = {
  white: {
    king: WhiteKing,
    queen: WhiteQueen,
    rook: WhiteRook,
...
export default function ChessPiece({ type, color, className = '' }: ChessPieceProps) {
  const Component = PIECE_COMPONENTS[color][type];
