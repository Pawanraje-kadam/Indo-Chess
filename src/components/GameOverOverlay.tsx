...
export default function GameOverOverlay() {
  ...
  return (
    <div className="overlay animate-fade-in" style={{ position:'absolute', borderRadius:'var(--radius)' }}>
      <div className="modal animate-fade-in-scale" style={{ position:'relative', boxShadow:`0 0 60px ${color}28, var(--shadow-xl)` }}>
        ...
        <button
          ...
          style={{
            ...
            fontSize:18, lineHeight:1, transition:'all 150ms',
          }}
